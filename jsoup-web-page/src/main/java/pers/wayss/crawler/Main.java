...
public class Main {
    ...
    private static final String URL = "https://blog.csdn.net/qq1332479771";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //获取总页数
//        String totalPageStr = body.getElementById("Paging_05791725436805422").select("span:eq(0)").text();
        String totalPageStr = body.getElementsByClass("ui-paging-container").toString();
        String regex = ".+共(\\d+)页";
